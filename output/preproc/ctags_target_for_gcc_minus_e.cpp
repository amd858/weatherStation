# 1 "D:\\workspace\\ArduinoProjects\\weather station\\summer_17_12_21\\weather_Station_without_rf\\heater&cooler\\heater&cooler.ino"
# 2 "D:\\workspace\\ArduinoProjects\\weather station\\summer_17_12_21\\weather_Station_without_rf\\heater&cooler\\heater&cooler.ino" 2

# 4 "D:\\workspace\\ArduinoProjects\\weather station\\summer_17_12_21\\weather_Station_without_rf\\heater&cooler\\heater&cooler.ino" 2
# 5 "D:\\workspace\\ArduinoProjects\\weather station\\summer_17_12_21\\weather_Station_without_rf\\heater&cooler\\heater&cooler.ino" 2
# 6 "D:\\workspace\\ArduinoProjects\\weather station\\summer_17_12_21\\weather_Station_without_rf\\heater&cooler\\heater&cooler.ino" 2
# 7 "D:\\workspace\\ArduinoProjects\\weather station\\summer_17_12_21\\weather_Station_without_rf\\heater&cooler\\heater&cooler.ino" 2
# 8 "D:\\workspace\\ArduinoProjects\\weather station\\summer_17_12_21\\weather_Station_without_rf\\heater&cooler\\heater&cooler.ino" 2
# 9 "D:\\workspace\\ArduinoProjects\\weather station\\summer_17_12_21\\weather_Station_without_rf\\heater&cooler\\heater&cooler.ino" 2
# 22 "D:\\workspace\\ArduinoProjects\\weather station\\summer_17_12_21\\weather_Station_without_rf\\heater&cooler\\heater&cooler.ino"
DHTesp dht;
DFRobot_SHT20 sht20;
...
{
  int a_button = !digitalRead(8); // 0.5
  int b_button = !digitalRead(7); // 1.0
  int minus_button = !digitalRead(6);
...
void press_rc_button(int rc_button_pin, bool enable_led) // remoteKey
{
  ...
  digitalWrite(rc_button_pin, 0x1);
  delay(KEY_DOWN_TIME);
  digitalWrite(rc_button_pin, 0x0);
  delay(KEY_UP_TIME);
  if (enable_led)
  {
    digitalWrite(4, 0x0);
...
void ac_on_sensor_fault()
{
  ...
  for (int i = 0; i < 30; i++)
  {
    press_rc_button(17, false);
  }

  for (int i = 0; i < 2; i++)
  {
    press_rc_button(5, false);
  }
  press_rc_button(5, true);
}
...
float Heater_Dip_Switch_Offset()
{
  int a_button = !digitalRead(8); // 0.5
  int b_button = !digitalRead(7); // 1.0
  int c_button = !digitalRead(6); // 2.0
  int minus_button = !digitalRead(3);
...
void setup()
{
  ...
  delay(100);
  HEATER_MODE_SELECTOR = digitalRead(9);
  delay(100);
...
void loop()
{
  ...
  bool ac_on_button = !digitalRead(11);
  float min_temp = 0;
  float max_temp = 0;
  float disier_hidx = 0;
